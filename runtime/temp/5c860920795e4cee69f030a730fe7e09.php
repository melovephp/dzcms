<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:30:"./admintpl/admin_role_add.html";i:1508376484;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<div class="row cl" >
			...
			<div class="formControls col-xs-8 col-sm-9" style="margin-top: 10px;">
				...
				<dl class="permission-list" >
					<dt>
						<label>
							<input type="checkbox" class="role" value="<?php echo $vo['id']; ?>" name="status" id="user-Character-0">
					...
					<dd>
						...
						<dl class="cl permission-list2">
							<dt>
								<label class="">
									<input type="checkbox" class="role" value="<?php echo $sec['id']; ?>" name="status" id="user-Character-0-0">
									<?php echo $sec['name']; ?></label>
							</dt>
							...
							<dd>
								...
								<label class="">
									<input type="checkbox" class="role" value="<?php echo $third['id']; ?>"  id="user-Character-0-0-0">
									<?php echo $third['name']; ?></label>
