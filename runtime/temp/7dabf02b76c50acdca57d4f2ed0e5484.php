<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./templates/Sofamall/article_list_content.html";i:1509702218;s:32:"./templates/Sofamall/header.html";i:1509702216;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div>
    ...
    <section class="article-content">
            <h4><?php echo $info['shorttitle']; ?></h4>
        <main>
          <?php echo $info['id']; ?>
        </main>
        <main>
