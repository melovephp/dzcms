<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:31:"./admintpl/user_grade_list.html";i:1508849310;s:65:"D:\phpStudy\WWW\new\dzcms/application/admin\view\public\foot.html";i:1508459970;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		...
		<table class="table table-border table-bordered table-hover">
			<tbody>
			  ...
			  <tr class="text-c">
				...
				<td>
					<a title="用户等级修改" href="javascript:;" onclick="article_edit('用户等级修改','usergradeup?id=<?php echo $info['id']; ?>','','')" style="text-decoration:none"><i class=" btn btn-warning radius size-S">修改</i></a>
