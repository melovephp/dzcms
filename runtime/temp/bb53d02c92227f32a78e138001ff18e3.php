<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:24:"./templates/lf/news.html";i:1509683580;s:26:"./templates/lf/header.html";i:1509667932;s:26:"./templates/lf/footer.html";i:1509609136;}*/ ?>
...
<div class="scd_bg">
	<div class="scd clearfix">
  	<div class="s_head clearfix">
		<a class="pcate " href="" title="新闻动态">新闻动态</a>
    <div class="pst">
    	<a href="http://www.xuyunhongsm.com/" title="北京旭云鸿商贸有限公司">首页</a> - <a href="http://www.xuyunhongsm.com/index.php?id=news" title="资讯中心">资讯中心</a> - <a href="" title=""></a>    
    </div>
    </div>
    <div class="scd_m clearfix">
<div class="mainer">
<?php  $taginfo=db('news')->field('*')->where("1=1 and cateid in (1)")->order('id asc')->limit(0,9)->select(); foreach($taginfo as $vo): $vo['catename']=db('category')->where('id='.$vo['cateid'])->find()['catename'];?>

							<div class="mainer_header_left">
						<div class="mainer_img">
							<a href="<?php echo $vo['url']; ?>"><img src="/public/Uploads/<?php echo $vo['smallimage']; ?>" /> </a>
						</div>
						<p class="mainer_header_left_p1"><a href="<?php echo $vo['url']; ?>" class="mainer_header_left_p1_a1"><?php echo $vo['title']; ?></a><a href="#" class="mainer_header_left_p1_a2"><?php echo date("Y-m-d",$vo['inputtime']); ?></a></p>
