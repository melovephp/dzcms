<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:29:"./admintpl/adcaterecover.html";i:1508813017;s:65:"D:\phpStudy\WWW\new\dzcms/application/admin\view\public\foot.html";i:1508459970;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<div class="wap-container">
		...
		<div class="container ui-sortable">
			...
			<div class="panel panel-default">
				...
				<span class="btn btn-danger radius"  class="ids" id="del_law_all">批量删除</span>
					<a type="button" class="btn btn-success radius" id="back_rule_all">一键还原</a>
					
					<span class="f-r">
                        <form action="<?php echo url('Ad/adcaterecover'); ?>" method="post" style="float: right;">
				...
				<thead>
					...
					<tr class="text-c">
						...
						<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')"><?php echo $list['name']; ?></u></td>
						<td><?php echo $list['content']; ?></td>
						<td class="td-status"><span class="label label-danger radius">已删除</span></td>
						<td class="td-manage">
						
							<!-- <a style="text-decoration:none" href="<?php echo url('Ad/rebackcate',['id'=>$list['id']]); ?>" class="ml-5 btn btn-success radius size-MINI"  onClick="member_huanyuan(this,'1')" title="还原">还原</a>  -->
						<input class="ml-5 btn btn-success radius size-MINI huanyuan" iddel="<?php echo $list['id']; ?>" type="button" value="还原">
							 <!-- <a title="删除" href="<?php echo url('Ad/deladcate',['id'=>$list['id']]); ?>" onclick="member_del(this,'1')" class="ml-5 btn btn-danger radius size-MINI" style="text-decoration:none">删除</a> -->
...
<script type="text/javascript" src="/public/lib/layer/2.4/layer.js"></script><script type="text/javascript">	
	//删除
    $('.subbut').click(function(){
	var id=$(this).attr('iddel');
	layer.confirm('确认要删除吗？',function(index){
        $.ajax({
            url:"<?php echo url('Ad/ajax_deladcate'); ?>",
            type:'POST',
            data:{id:id},
                   ...
                   case 1:
                        layer.msg(result.msg, {
                         ...
                         setInterval(function () {
                                    location.href="<?php echo url('Ad/adcaterecover'); ?>";
                                },1000);
                    break;
	...
	$('.huanyuan').click(function(){
        ...
        $.ajax({
            url:"<?php echo url('Ad/ajax_rebackcate'); ?>",
            type:'POST',
            data:{id:id},
            success:function(result){
                //alert(result.msg);
