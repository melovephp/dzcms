...
function button1_click(event)
{
     ...
     clearTimeout(timer);
     timer = setTimeout(eval("button2_click"),"8000");
     $("#image1").animate({"opacity":1},300, "linear", null);
}
...
function button3_click(event)
{
     ...
     clearTimeout(timer);
     timer = setTimeout(eval("button4_click"),"8000");
     $("#image3").animate({"opacity":1},300, "linear", null);
}
...
function button4_click(event)
{
     ...
     clearTimeout(timer);
     timer = setTimeout(eval("button5_click"),"8000");
     $("#image4").animate({"opacity":1},300, "linear", null);
}
...
$(".slideshow .slides li").mouseover(function(){
	
	clearTimeout(timer);
});

$(".slideshow .slides li").mouseout(function(){
	clearTimeout(timer);
	var id =this.id;
	...
	timer = setTimeout(eval("button"+index+"_click"),"4000");
});
